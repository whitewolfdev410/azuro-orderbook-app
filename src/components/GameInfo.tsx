    ...
    <div className="relative">
      <div className="grid grid-cols-[1fr_1fr_auto_1fr_1fr] items-center">
        <div className="col-start-2">
          <Participant {...participants[0]} size="lg" className="flex-col" textCenter={true} textAbove={true}/>
        </div>
        ...
        <div className="col-start-4">
          <Participant {...participants[1]} size="lg" className="flex-col" textCenter={true} textAbove={true}/>
        </div>
      </div>
    </div>
  )
